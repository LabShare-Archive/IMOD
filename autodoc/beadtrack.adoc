...
[Field = IsolatedBeadCriterionFactor]
short = 
type = F
usage = Factor by which to increase residual criteria for an isolated bead
tooltip = Factor by which to increase residual criteria for an isolated bead.
manpage =
