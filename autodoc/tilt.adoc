...
tooltip = 
manpage = Use the GPU (graphical processing unit) for computations where
...
backprojection, and for reprojections from a reconstruction that do not 
involve local alignments.
