...
starting and ending tilt angle and a defocus value.  The program will assign
that defocus value to the midpoint of the range.  For a view at a given tilt
...
file with a single line containing "0 0 defocus_value".
