...
[SectionHeader = File-Based Automation Options]
[Field = fromBRT]
type=B
...
[SectionHeader = Command-Line-Based Automation Options]
[Field = axis]
...
[SectionHeader = Diagnostic Options]
[Field = actions]
type=B
...
[SectionHeader = Development and Testing Options]
...
[SectionHeader = Deprecated Options]
[Field = demo]
type=B
usage=Deprecated
