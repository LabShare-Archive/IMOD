...
positions of the patch centers in an IMOD model.  You must also enter either
the -number option for a regular array of patches, or the -seed option for
patches at modeled locations.  This option cannot be used with cumulative
correlation.
