...
applied after binning and transformation, if any.  If no output size is
...
^    1: Blackman - faster but not as good at antialiasing, used in 3dmod
^    2: Mitchell - good at antialiasing, smooths a bit
^    3: Lanczos 2 lobes - good at antialiasing, less smoothing
^    4: Lanczos 3 lobes - slower, even less smoothing but more risk of ringing
^The default is 3 for the Lanczos 2, which many people consider the best
