...
set the minimum sizes of these groups.  The program stops with an error if the
total number of points available for fitting falls below the minimum.  The
defaults are 100 and 65.
