...
type = IP
usage = Minimum sizes for groups of points for computing weights, global and local
tooltip = 
manpage = 

[Field = KFactorForWeights]
type = I
usage = Scaling factor of median absolute deviation when computing weights
tooltip = 
manpage = 
