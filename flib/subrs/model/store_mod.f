...
c   DNM 12/21/88 changed to work with new format for dealing with text labels
c	  and cleaned up declarations now that all model stuff is in .inc file
...
c	  print*,' iobject=',i
	  write(20,'(a11,i)',err=99)'  Object #:',i
	  write(20,'(a12,i)',err=99)' # of point:',npt_in_obj(i)
