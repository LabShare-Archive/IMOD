...
C	OPEN(UNIT=IUNIT,FILE=FNAME,CARRIAGECONTROL='LIST',
C       .	STATUS=ITYPE,FORM=FORMAT)
      OPEN(UNIT=IUNIT,FILE=FNAME,STATUS=ITYPE,FORM=FORMAT,ERR=30)
      GOTO 20
C       5	OPEN(UNIT=IUNIT,FILE=FNAME,CARRIAGECONTROL='LIST',
C       .	STATUS='OLD',FORM=FORMAT,SHARED,READONLY)
5     OPEN(UNIT=IUNIT,FILE=FNAME,STATUS='OLD',FORM=FORMAT,ERR=30)
      GOTO 20
C       
...
10    IF (ITYPE .EQ. 'RO' .OR. ITYPE .EQ. 'ro') GOTO 15
      OPEN(UNIT=IUNIT,FILE=FNAME,STATUS=ITYPE,FORM=FORMAT,ERR=30)
      GOTO 20
C       15	OPEN(UNIT=IUNIT,FILE=FNAME,STATUS='OLD',FORM=FORMAT,SHARED,
C       .	READONLY)
15    OPEN(UNIT=IUNIT,FILE=FNAME,STATUS='OLD',FORM=FORMAT,ERR=30)
C       
