c   function CONCAT will concatenate two string arguments, eliminating leading
c   and trailing blanks.  It can handle either argument being blank; if both
c   are blank, it will return ' '.  Embedded blanks are retained
        character*80 function concat(str1,str2)
        character*(*) str1,str2
