...
[[if = test-gui]]
  ...
  assert.rb.multiparticle-reference=off
  assert.cbb.multiparticle-reference=32
  #enabled
  ...
  assert.enabled.rb.multiparticle-reference=
  assert.disabled.cbb.multiparticle-reference=
[[]]
...
[[if = test-gui]]
  ...
  assert.disabled.tf.user-supplied-file=
  assert.enabled.cbb.multiparticle-reference=
...
cbb.multiparticle-reference-with=128
save=
