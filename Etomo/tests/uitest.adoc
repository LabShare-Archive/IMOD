...
open.interface.bn.tomographic-reconstruction=
...
[interface = Join]
goto.frame.pnl.main-frame =
open.interface.bn.join-tomograms=
...
[interface = PEET]
goto.frame.pnl.main-frame =
open.interface.bn.peet=

[Interface = Nad]
goto.frame.pnl.main-frame =
open.interface.bn.nonlinear-anisotropic-diffusion=

[Interface = Generic]
goto.frame.pnl.main-frame =
open.interface.bn.generic-parallel-process=
