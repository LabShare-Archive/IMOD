...
[Test = dual-testBB-test-gui]
set.testdir = dual-testBB-test-gui
#set.keep.testdir = dual-test-gui
set.adoc.dialog.a=recon.adoc
set.adoc.bdialog.b=recon.adoc
set.var.dataset = testBB
set.dataset = testBB
copy.file.a = %{dataset}a.st
copy.file.b = %{dataset}b.st
set.param = --autoclose3dmod
...
[Test = single-testmontage-test-gui]
set.testdir = single-testmontage-test-gui
set.adoc.dialog = recon.adoc
set.var.dataset = testmidzone2a
set.dataset = testmidzone2
set.param = --autoclose3dmod
set.param = --ignoreloc
set.param = --actions
set.var.single=
...
[Test = dual-testmontage-patch-tracking]
set.testdir = dual-testmontage-patch-tracking
#set.keep.testdir = dual-montage-patch-tracking
set.adoc.dialog.a=recon.adoc
set.adoc.bdialog.b=recon.adoc
set.var.dataset = testmidzone2
set.dataset = testmidzone2
set.param = --autoclose3dmod
set.param = --ignoreloc
set.param = --actions
...
[Test = join-testunicross-test-gui]
set.testdir = join-testunicross-test-gui
set.adoc.tab = join.adoc
set.var.dataset = testunicross
set.dataset = testunicross
set.var.test-gui=
copy.file = %{dataset}2.rec
copy.file = %{dataset}3.rec
set.param = --autoclose3dmod
...
[Test = nad-testunicross]
set.testdir = nad-testunicross
set.adoc.dialog = nad.adoc
set.var.dataset = testunicross
set.dataset = testunicross
set.param = --autoclose3dmod
set.param = --ignoreloc
set.param = --actions
set.var.volume=testunicross1.rec
set.interface.Nad=
...
set.var.tomogram-thickness-in-z-patch-tracking.a=88
set.var.x-axis-tilt.a=1.76
set.var.x-axis-tilt.b=0.13
set.var.x-axis-tilt-patch-tracking.a=1.48
#PostProc
set.var.scaling-z-min=25
set.var.scaling-z-max=50
set.var.scaling-z-min-patch-tracking=29
set.var.scaling-z-max-patch-tracking=58
...
set.var.incremental-shift-to-center.a=28.8
...
[dataset = testmidzone2]
use.dataset = midzone2

[dataset = unicross]
copy.file = %{dataset}1.rec

[dataset = testunicross]
use.dataset = unicross
