...
open.interface.bn.new-tomogram=
...
[interface = PEET]
goto.frame.pnl.main-frame =
open.interface.bn.new-peet=

[Interface = Nad]
goto.frame.pnl.main-frame =
open.interface.bn.new-nonlinear-anisotropic-diffusion=

[Interface = Generic]
goto.frame.pnl.main-frame =
open.interface.bn.new-generic-parallel-process=
