...
bn.generate-tomogram=
[[if = test-gui]]
  wait.process.processchunks-tilt%{axis}=ETC
  bn.kill-process=
  wait.done.process.processchunks-tilt%{axis}=killed
  bn.generate-tomogram=
[[]]
wait.done.process.processchunks-tilt%{axis}=done
if.var.build.return=
# check files
...
bn.generate-tomogram=
[[if = test-gui]]
  wait.process.processchunks-tilt%{axis}=1 of
  bn.kill-process=
  wait.done.process.processchunks-tilt%{axis}=killed
  bn.generate-tomogram=
[[]]
...
[[ifnot = montage]]
  ...
  cb.reconstruct-subarea=off
  bn.run-sirt=
  wait.done.process.processchunks-tilt%{axis}_sirt=done
  bn.view-tomogram-in-3dmod=
