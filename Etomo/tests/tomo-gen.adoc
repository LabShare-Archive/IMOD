...
[[if = test-gui]]
  ...
  assert.cb.scale-retained-volumes-to-integers=
  assert.cb.delete-existing-reconstructions-after-starting-point=
  assert.rb.start-from-beginning=on
  assert.rb.resume-from-last-iterations=off
  ...
  mb.sirt.1=A
  cb.disabled.take-logarithm-of-densitities-with-offset=
  tf.disabled.logarithm-density-scaling-factor=
  tf.disabled.offset=
  tf.disabled.linear-density-scaling-factor=
  tf.disabled.offset.1=
  tf.disabled.tomogram-thickness-in-z=
  tf.disabled.z-shift=
  tf.disabled.z-axis-tilt=
  tf.disabled.tilt-angle-offset=
  tf.disabled.extra-views-to-exclude=
  cb.disabled.use-local-alignments=
  cb.disabled.use-z-factors=
  mb.sirt.1=B
  cb.disabled.resconstruct-subarea=
  tf.disabled.radial-filter-cutoff=
  tf.disabled.falloff=
  ...
  assert.enabled.rb.resume-from-last-iterations=
  ...
  rb.disable.resume-from-last-iteration=
  rb.disable.go-back,-resume-from-iteration=
