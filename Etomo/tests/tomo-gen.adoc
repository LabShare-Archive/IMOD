...
[[if = test-gui]]
  ...
  mb.sirt.1=A
  assert.disabled.cb.take-logarithm-of-densitities-with-offset=
  assert.disabled.tf.logarithm-density-scaling-factor=
  assert.disabled.tf.offset=
  assert.disabled.tf.linear-density-scaling-factor=
  assert.disabled.tf.offset.1=
  ...
  assert.disabled.tf.z-axis-tilt=
  ...
  mb.sirt.1=B
  assert.disabled.cb.resconstruct-subarea=
  assert.disabled.tf.radial-filter-cutoff=
