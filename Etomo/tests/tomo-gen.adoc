...
[[if = test-gui]]
	...
	mb.tilt.1=A
	assert.cb.take-the-log-with-offset=on
	assert.tf.take-the-log-with-offset=0.0
	assert.tf.log-density-scaling-factor=%{output-density-scaling-factor}
	...
	assert.enabled.cb.take-the-log=
	...
	mb.tilt.1=A
	assert.enabled.tf.take-the-log-with-offset=
	assert.enabled.tf.log-density-scaling-factor=
	...
	cb.take-the-log=off
	mb.tilt.1=A
	assert.disabled.tf.take-the-log-with-offset=
	assert.disabled.tf.log-density-scaling-factor=
	assert.disabled.tf.offset=
	assert.enabled.tf.linear-density-scaling-factor=
	assert.enabled.tf.offset.1=
	cb.take-the-log-with-offset=on
	assert.enabled.tf.take-the-log-with-offset=
	assert.enabled.tf.log-density-scaling-factor=
	assert.enabled.tf.offset=
	assert.disabled.tf.linear-density-scaling-factor=
