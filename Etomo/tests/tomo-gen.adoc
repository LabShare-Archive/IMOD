...
bn.generate-tomogram=
[[if = test-gui]]
  if.wait.process.processchunks-tilt%{axis}.run.function.test-kill=ETC
[[]]
...
bn.generate-tomogram=
[[if = test-gui]]
  if.wait.process.processchunks-tilt%{axis}.run.function.test-kill=1 of
[[]]
...
[function = test-kill]
bn.kill-process=
wait.process.processchunks-tilt%{axis}=killed
bn.generate-tomogram=
