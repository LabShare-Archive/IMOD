...
if.not.var.montage.wait.done.process.creating-aligned-stack=done
if.var.montage.wait.done.process.full-alignment=done
...
[[]]
bn.correct-ctf=
wait.done.process.processchunks-ctfcorrection%{axis}=done
[[if = test-gui]]
  #check binned pixel size
...
bn.correct-ctf=
wait.done.process.running-ctf-correction=done
...
wait.done.process.running-xfmodel=done
# check files
...
wait.done.process.tilt_3dfind_reproject=done
# check files
...
wait.done.process.processchunks-tilt_3dfind%{axis}=done
# check files
assert.exists.file=tilt_3dfind%{axis}.com
...
# run
bn.run-findbeads3d=
wait.done.process.findbeads3d=done
# check files
...
# run
bn.filter =
wait.done.process.running-mtf-filter=done
# check files
