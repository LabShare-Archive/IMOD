...
wait.done.process.creating-combine-scripts = done
...
bn.start-combine =
[[if = test-gui]]
  wait.process.processchunks-volcombine=1 of
  bn.kill-process=
  wait.done.process.processchunks-volcombine=killed
  bn.start-combine =
[[]]
wait.done.process.processchunks-volcombine = done
...
[[if = test-gui]]
  wait.process.combine=ETC
  bn.kill-process=
  wait.done.process.combine=killed
  bn.restart-at-volcombine =
[[]]
wait.done.process.combine = done
