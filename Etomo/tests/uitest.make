all: gpu-test-gui single-test-gui peet-test-gui join-test-gui serial-sections-test-gui nad-test-gui generic-test-gui flatten-volume-test-gui dual-test-gui serial-sections-montage-test-gui single-montage-test-gui single-patch-tracking-test-gui single-fidless-test-gui single-simple-align-test-gui dual-montage-test-gui dual-montage-patch-tracking
