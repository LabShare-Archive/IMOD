all: single-test-gui single-patch-tracking-test-gui single-fidless single-simple-align dual-test-gui single-montage-test-gui dual-montage-test-gui dual-montage-patch-tracking peet-test-gui join-test-gui serial-sections-test-gui serial-sections-montage-test-gui nad-test-gui generic flatten-volume-test-gui gpu-test-gui
