...
public class FortranInputStringTest extends TestCase {
  ...
  public void testSimpleTuple() {
    ...
    assertEquals("Incorrect simple triple toString", triple, fisTriple
    .toString());
  ...
  public void testIntegerTuple() {
    ...
    assertEquals("Incorrect mixed triple toString", triple, fisTriple
      .toString());
  ...
  public void testDefaultSpecifier() {
    ...
    assertEquals("Incorrect all default specifier toString", allDefSpec, all
    .toString());
    ...
    assertEquals("Incorrect rest of default specifier toString", restOfSpec, 
    restOfArgs.toString());
    ...
    assertEquals("Incorrect first default specifier toString", firstDefSpec, 
    firstDefault.toString());
