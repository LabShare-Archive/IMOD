...
public final class TrackLog implements Loggable {
   ...
   */
  public List getLogMessage() throws LogFile.LockException,FileNotFoundException,IOException {
    lineList.clear();
    //refresh the log file
    LogFile trackLog = LogFile
        .getInstance(userDir, axisID, ProcessName.TRACK);
    if (trackLog.exists()) {
