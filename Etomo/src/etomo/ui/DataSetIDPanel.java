...
public class DataSetIDPanel {
  ...
  private void setToolTipText() {
    ...
    ltfDataSet.setToolTipText(
      "<html>This specifies the data set to use within the working<br>directory.  For single axis data sets omit the .st<br>from the filename.  For dual axis data sets omit the<br>a.st from the file name.<br><br>To set this parameter run the setup process below<br>to start a new tomogram.");
