...
public class ApplicationManager {
  ...
  */
  public void openSetupDialog() {
    ...
    setupDialog.setLocation((screenSize.width - size.width)/2,
  ...
  public void openPreProcDialog() {
    ...
    preProcDialog.setLocation((screenSize.width - size.width)/2,
      (screenSize.height - size.height)/2);
	...
	comScriptMgr.getCCDEraserParam(AxisID.FIRST), AxisID.FIRST);

      comScriptMgr.loadEraserCom(AxisID.SECOND);
      preProcDialog.setCCDEraserParams(
	comScriptMgr.getCCDEraserParam(AxisID.SECOND), AxisID.SECOND);
      preProcDialog.setEnabledB(true);
    }
    else {
      comScriptMgr.loadEraserCom(AxisID.ONLY);
      preProcDialog.setCCDEraserParams(
	comScriptMgr.getCCDEraserParam(AxisID.ONLY), AxisID.ONLY);
  ...
  public void openCoarseAlignDialog() {
    ...
    coarseAlignDialog.setLocation((screenSize.width - size.width)/2,
      (screenSize.height - size.height)/2);
	...
	comScriptMgr.getTiltxcorrParam(AxisID.FIRST),  AxisID.FIRST);

      comScriptMgr.loadXcorrCom(AxisID.SECOND);
      coarseAlignDialog.setCrossCorrelationParams(
	comScriptMgr.getTiltxcorrParam(AxisID.SECOND),  AxisID.SECOND);
      ...
      coarseAlignDialog.setCrossCorrelationParams(
	comScriptMgr.getTiltxcorrParam(AxisID.ONLY),  AxisID.ONLY);
   ...
   */
  public void crossCorrelate(AxisID axisID, CoarseAlignDialog coarseAlignDialog) {
  ...
  public void openFiducialModelDialog() {
    ...
    fiducialModelDialog.setLocation((screenSize.width - size.width)/2,
      (screenSize.height - size.height)/2);
	...
	comScriptMgr.getBeadtrackParam(AxisID.FIRST), AxisID.FIRST);

      comScriptMgr.loadTrackCom(AxisID.SECOND);
      fiducialModelDialog.setBeadtrackParams(
	comScriptMgr.getBeadtrackParam(AxisID.SECOND), AxisID.SECOND);
      ...
      fiducialModelDialog.setBeadtrackParams(
	comScriptMgr.getBeadtrackParam(AxisID.ONLY), AxisID.ONLY);
  ...
  public void openAlignmentEstimationDialog() {
    ...
    alignmentEstimationDialog.setLocation((screenSize.width - size.width)/2,
      (screenSize.height - size.height)/2);
	...
	comScriptMgr.getTiltalignParam(AxisID.FIRST) , AxisID.FIRST);

      comScriptMgr.loadAlignCom(AxisID.SECOND);
      alignmentEstimationDialog.setTiltalignParams(
	comScriptMgr.getTiltalignParam(AxisID.SECOND) , AxisID.SECOND);
      ...
      alignmentEstimationDialog.setTiltalignParams(
	comScriptMgr.getTiltalignParam(AxisID.ONLY) , AxisID.ONLY);
  ...
  private boolean updateAlignCom(
	...
	alignmentEstimationDialog.getTiltalignParams(tiltalignParam,
	  currentAxis);
  ...
  public void openTomogramPositioningDialog() {
    ...
    //  Open the dialog in the appropriate mode for the current state of
    //  processing
    TomogramPositioningDialog tomogramPositioningDialog = new
      TomogramPositioningDialog(this);

    Dimension size = tomogramPositioningDialog.getSize();
    tomogramPositioningDialog.setLocation((screenSize.width - size.width)/2,
      (screenSize.height - size.height)/2);
	...
	comScriptMgr.getTiltParam(AxisID.FIRST), AxisID.FIRST);
	...
	comScriptMgr.getTiltalignParam(AxisID.FIRST), AxisID.FIRST);
      ...
      tomogramPositioningDialog.setTiltParams(
	comScriptMgr.getTiltParam(AxisID.SECOND) , AxisID.SECOND);
	...
	comScriptMgr.getTiltalignParam(AxisID.SECOND), AxisID.SECOND);
      ...
      tomogramPositioningDialog.setTiltParams(
	comScriptMgr.getTiltParam(AxisID.ONLY) , AxisID.ONLY);
  ...
  public void finalAlign(TomogramPositioningDialog tomogramPositioningDialog,
    AxisID axisID) {
  ...
  public void openTomogramGenerationDialog() {
    ...
    //  Open the dialog in the appropriate mode for the current state of
    //  processing
    TomogramGenerationDialog tomogramGenerationDialog = new
      TomogramGenerationDialog(this);
    Dimension size = tomogramGenerationDialog.getSize();
    tomogramGenerationDialog.setLocation((screenSize.width - size.width)/2,
      (screenSize.height - size.height)/2);
  ...
  public void openTomogramCombinationDialog() {
    ...
    tomogramCombinationDialog.setLocation((screenSize.width - size.width)/2,
      (screenSize.height - size.height)/2);
  ...
  public void openTestParamFile(File paramFile) {
    ...
    try {
      ...
      mainFrame.setFiducialModelState(processTrack.getFiducialModelState());
      mainFrame.setAlignmentEstState(processTrack.getFineAlignmentState());
      mainFrame.setTomogramPositioningState(processTrack.
	getTomogramPositioningState());
      mainFrame.setTomogramGenerationState(
	processTrack.getTomogramGenerationState());
      mainFrame.setTomogramCombinationState(
	processTrack.getTomogramCombinationState());
  ...
  private void initProgram() {
    ...
    ToolTipManager.sharedInstance().
      setInitialDelay(userConfig.getToolTipsInitialDelay());
    ToolTipManager.sharedInstance().
      setDismissDelay(userConfig.getToolTipsDismissDelay());
  ...
  public boolean exitProgram() {
	...
	"Save the current data file ?", "Save data file?",
  ...
  private static void setLookAndFeel(boolean nativeLookAndFeel) {
    ...
    try {
      ...
      System.out.println("Could not set " + lookAndFeelClassName
	+ " look and feel");
    }
  }
