...
Contributors:
    * Sergey Bochkanov (ALGLIB project). Translation from FORTRAN to
      pseudocode.
    * Modified by Stephen Gould <sgould@stanford.edu> for class interface.
...
typedef void(*funcgrad_t)(ap::real_1d_array x, double& f, ap::real_1d_array& g,
    void *params);
typedef void(*newiteration_t)(int iter, const ap::real_1d_array& x, double f,
...
Input parameters:
    ...
    funcgrad - function for computing objective and gradient
    newiteration - function for monitoring progress
    params - parameters to pass to funcgrad and newiteration
