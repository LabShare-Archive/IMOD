# Microsoft Developer Studio Project File - Name="3dmod" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86)  Application" 0x0101

CFG=3dmod - Win32 Release
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "3dmod.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "3dmod.mak" CFG="3dmod - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "3dmod - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "3dmod - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
# PROP Target_Dir ""
# ADD CPP -MD /W3 /I "..\include" /I "." /I "$(QTDIR)\include" /I "tmp\" /I "" /I "tmp\" /I "$(QTDIR)\mkspecs\win32-msvc" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D UNICODE /D QT_DLL /D QT_THREAD_SUPPORT /D "QT_NO_DEBUG" /FD /c -nologo -Zm200 -O1
# ADD MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD RSC /l 0x409 /d "NDEBUG"
BSC32=bscmake.exe
# ADD BSC32 /nologo
LINK32=link.exe
# ADD LINK32  "qt-mt311.lib"  "qtmain.lib"  "opengl32.lib"  "glu32.lib"  "delayimp.lib"  "libdiaqt.lib"  "libimod.lib"  "libiimod.lib"  "kernel32.lib"  "user32.lib"  "gdi32.lib"  "comdlg32.lib"  "advapi32.lib"  "shell32.lib"  "ole32.lib"  "oleaut32.lib"  "uuid.lib"  "imm32.lib"  "winmm.lib"  "wsock32.lib"  "winspool.lib"  /subsystem:windows  /NOLOGO /DELAYLOAD:opengl32.dll /LIBPATH:"$(QTDIR)\lib" delayimp.lib /DELAYLOAD:comdlg32.dll /DELAYLOAD:oleaut32.dll /DELAYLOAD:winmm.dll /DELAYLOAD:wsock32.dll /DELAYLOAD:winspool.dll /LIBPATH:..\buildlib /NODEFAULTLIB:libc.lib /NODEFAULTLIB:libcd.lib /NODEFAULTLIB:msvcrtd.lib
...
# PROP Target_Dir ""
# ADD CPP -MDd /W3 /Gm /GZ /ZI /Od /I "..\include" /I "." /I "$(QTDIR)\include" /I "tmp\" /I "" /I "tmp\" /I "$(QTDIR)\mkspecs\win32-msvc" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D UNICODE /D QT_DLL /D QT_THREAD_SUPPORT /FD /c -nologo -Zm200 -Z7
# ADD MTL /nologo /D "_DEBUG" /mktyplib203 /win32
# ADD RSC /l 0x409 /d "_DEBUG"
BSC32=bscmake.exe
# ADD BSC32 /nologo
LINK32=link.exe
# ADD LINK32  "qt-mt311.lib"  "qtmain.lib"  "opengl32.lib"  "glu32.lib"  "delayimp.lib"  "libdiaqt.lib"  "libimod.lib"  "libiimod.lib"  "kernel32.lib"  "user32.lib"  "gdi32.lib"  "comdlg32.lib"  "advapi32.lib"  "shell32.lib"  "ole32.lib"  "oleaut32.lib"  "uuid.lib"  "imm32.lib"  "winmm.lib"  "wsock32.lib"  "winspool.lib"  /subsystem:windows  /NOLOGO /DELAYLOAD:opengl32.dll /LIBPATH:"$(QTDIR)\lib" /pdbtype:sept /DEBUG /LIBPATH:..\buildlib /NODEFAULTLIB:libc.lib /NODEFAULTLIB:libcd.lib /NODEFAULTLIB:msvcrt.lib
...
# Name "3dmod - Win32 Release"
# Name "3dmod - Win32 Debug"
...
USERDEP_imod_client_message="$(QTDIR)\bin\moc.exe"
...
USERDEP_imod_info="$(QTDIR)\bin\moc.exe"
...
USERDEP_imod_cachefill="$(QTDIR)\bin\moc.exe"
...
USERDEP_imod_model_edit="$(QTDIR)\bin\moc.exe"
...
USERDEP_imod_iscale="$(QTDIR)\bin\moc.exe"
...
USERDEP_imod_cont_edit="$(QTDIR)\bin\moc.exe"
...
USERDEP_imod_cont_copy="$(QTDIR)\bin\moc.exe"
...
USERDEP_imod_workprocs="$(QTDIR)\bin\moc.exe"
...
USERDEP_iproc="$(QTDIR)\bin\moc.exe"
...
USERDEP_slicer_classes="$(QTDIR)\bin\moc.exe"
...
USERDEP_xtum="$(QTDIR)\bin\moc.exe"
...
USERDEP_xxyz="$(QTDIR)\bin\moc.exe"
...
USERDEP_xgraph="$(QTDIR)\bin\moc.exe"
...
USERDEP_imod_object_edit="$(QTDIR)\bin\moc.exe"
...
USERDEP_pixelview="$(QTDIR)\bin\moc.exe"
...
USERDEP_zap_classes="$(QTDIR)\bin\moc.exe"
...
USERDEP_imodv_window="$(QTDIR)\bin\moc.exe"
...
USERDEP_imodv_menu="$(QTDIR)\bin\moc.exe"
...
USERDEP_imodv_stereo="$(QTDIR)\bin\moc.exe"
...
USERDEP_imodv_objed="$(QTDIR)\bin\moc.exe"
...
USERDEP_imodv_image="$(QTDIR)\bin\moc.exe"
...
USERDEP_preferences="$(QTDIR)\bin\moc.exe"
...
USERDEP_beadfix="$(QTDIR)\bin\moc.exe"
...
USERDEP_form_object_edit.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"
...
USERDEP_formv_control.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"
...
USERDEP_formv_movie.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"
...
USERDEP_formv_modeled.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"
...
USERDEP_formv_views.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"
...
USERDEP_formv_depthcue.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"
...
USERDEP_formv_objed.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"
...
SOURCE=form_info.ui
USERDEP_form_info.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"
...
USERDEP_form_moviecon.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"
...
USERDEP_form_autox.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"
...
USERDEP_form_cont_edit.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"
...
USERDEP_form_appearance.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"
...
USERDEP_form_behavior.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"
...
USERDEP_form_mouse.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"
...
SOURCE=form_startup.ui
USERDEP_form_startup.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"

!IF  "$(CFG)" == "3dmod - Win32 Release"

# Begin Custom Build - Uic'ing form_startup.ui...
InputPath=.\form_startup.ui

BuildCmds= \
	$(QTDIR)\bin\uic form_startup.ui -o tmp\form_startup.h \
	$(QTDIR)\bin\uic form_startup.ui -i form_startup.h -o tmp\form_startup.cpp \
	$(QTDIR)\bin\moc tmp\form_startup.h -o tmp\moc_form_startup.cpp \

"tmp\form_startup.h" : "$(SOURCE)" "$(INTDIR)" "$(OUTDIR)"
	$(BuildCmds)

"tmp\form_startup.cpp" : "$(SOURCE)" "$(INTDIR)" "$(OUTDIR)"
	$(BuildCmds)

"tmp\moc_form_startup.cpp" : "$(SOURCE)" "$(INTDIR)" "$(OUTDIR)"
	$(BuildCmds)
...
SOURCE=uparrow.png
USERDEP_uparrow.png="uparrow.png"\
"downarrow.png"\
"rightarrow.png"\
"leftarrow.png"\
"raisewindow.png"
...
"tmp\qmake_image_collection.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	$(QTDIR)\bin\uic -embed 3dmod -f images.tmp -o tmp\qmake_image_collection.cpp
...
SOURCE=tmp\moc_form_startup.cpp
# End Source File
